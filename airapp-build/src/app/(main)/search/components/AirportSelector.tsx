  ...
  return (
    <div ref={containerRef} className="relative">
      ...
      {isOpen && (
        ...
        >
          {query.length === 0 && (
            <div className="px-3 py-2 text-xs font-medium text-primary-400 dark:text-[oklch(60%_0.005_50)] uppercase tracking-wider flex items-center gap-1">
          ...
          {filtered.length > 0 ? (
            filtered.map((airport) => (
              <button
                ...
                className={cn(
                  ...
                  'hover:bg-primary-50 dark:hover:bg-[oklch(25%_0.005_50)]',
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <span className="text-sm text-primary-600 dark:text-[oklch(80%_0.005_50)] ml-2">
            ...
            <div className="px-3 py-4 text-sm text-primary-500 dark:text-[oklch(70%_0.008_50)] text-center">

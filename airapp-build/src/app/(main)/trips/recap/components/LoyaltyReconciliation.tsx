  ...
  return (
    <section aria-labelledby="loyalty-heading" className="space-y-3">
      ...
      <div className="bg-surface dark:bg-[oklch(18%_0.003_50)] rounded-[var(--radius-lg)] border border-surface-300 dark:border-[oklch(32%_0.008_50)] p-4 space-y-4">
        ...
        <ul className="space-y-2" aria-label="Points earned">
          {loyalty.items.map((item, i) => (
            ...
            >
              ...
              <span className="text-sm font-medium text-primary-900 dark:text-[oklch(95%_0.002_50)] tabular-nums">
        ...
        {/* New balance */}
        <div className="flex items-center justify-between bg-primary-50 dark:bg-[oklch(15%_0.008_262)] rounded-[var(--radius-md)] px-3 py-2.5">

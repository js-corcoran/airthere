    ...
    >
      ...
      >
        ...
        <div className="flex items-center justify-between mb-4">
          <div className="w-10 h-1 bg-surface-300 dark:bg-[oklch(40%_0.005_50)] rounded-full" />
          <button
            onClick={onClose}
            className={cn(
        ...
        {uploading ? (
          <div className="flex flex-col items-center py-8">
            <div className="w-16 h-16 rounded-full border-4 border-primary-200 dark:border-[oklch(30%_0.010_262)] border-t-primary-500 dark:border-t-[oklch(65%_0.194_262)] animate-spin mb-4" />
            <p className="text-sm font-medium text-primary-900 dark:text-[oklch(95%_0.002_50)] mb-2">
              Uploading & Encrypting...
            </p>
            <div className="w-48 h-1.5 bg-surface-200 dark:bg-[oklch(25%_0.005_50)] rounded-full overflow-hidden">
              <div
                className="h-full bg-primary-500 dark:bg-[oklch(65%_0.194_262)] rounded-full transition-all duration-[--duration-short]"
          ...
          <>
            ...
            <label className="block mb-4">
              <span className="text-sm font-medium text-primary-900 dark:text-[oklch(95%_0.002_50)] mb-1.5 block">
                Document Name
              </span>
              <input
                type="text"
              ...
              {[
                ...
                <button
                  ...
                  className={cn(
                    ...
                    'dark:border-[oklch(40%_0.030_262)]',
                ...
                >
                  <Icon className="w-6 h-6 text-primary-500 dark:text-[oklch(65%_0.194_262)]" aria-hidden="true" />

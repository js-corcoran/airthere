  ...
  return (
    <section
      className={cn(
        ...
        'dark:from-surface-success dark:to-surface-info',
    ...
    >
            ...
            <button
              ...
              className={cn(
                ...
                sleepTimerActive
                  ...
                  : 'bg-surface-200 text-primary-700 dark:bg-input dark:text-muted-foreground'
              )}
            >
      ...
      <button
        ...
        className={cn(
          ...
          'hover:bg-surface-200 dark:hover:bg-surface-100',
          'transition-colors duration-[--duration-micro]',
          'focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary-500',
          'min-h-[var(--touch-min)]'
        )}
      >
        <Lightbulb className="w-4 h-4 text-secondary-500 dark:text-secondary-400 shrink-0" aria-hidden="true" />
      ...
      {showJetLagTips && (
        <ul className="mt-2 space-y-2 pl-2">
          {data.jetLagTips.map((tip, i) => (
            <li
              key={i}
              className="flex items-start gap-2 text-xs text-primary-700 dark:text-muted-foreground"
            >
              <span className="w-4 h-4 rounded-full bg-secondary-100 dark:bg-input text-secondary-700 dark:text-muted-foreground text-[10px] font-bold flex items-center justify-center shrink-0 mt-0.5">
                {i + 1}
              </span>
              {tip}
            </li>

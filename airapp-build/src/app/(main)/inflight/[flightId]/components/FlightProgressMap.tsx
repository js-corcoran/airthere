    ...
    >
      ...
      <div
        className={cn(
          ...
          'dark:from-[oklch(20%_0.010_262)] dark:to-[oklch(15%_0.005_262)]'
        )}
      >
        {/* Route visualization */}
        <svg
        ...
        >
          ...
          <path
            ...
            strokeWidth="2"
            strokeDasharray="6 4"
            className="dark:stroke-[oklch(40%_0.030_262)]"
          />
          {/* Progress line */}
          <path
            d="M 40 120 Q 200 20 360 100"
            ...
            className="dark:stroke-[oklch(65%_0.194_262)]"
          />
          {/* Departure dot */}
          <circle cx="40" cy="120" r="5" fill="oklch(57.5% 0.194 262)" className="dark:fill-[oklch(65%_0.194_262)]" />
          {/* Arrival dot */}
          <circle cx="360" cy="100" r="5" fill="oklch(85% 0.030 262)" className="dark:fill-[oklch(40%_0.030_262)]" />
          {/* Departure label */}
          <text x="40" y="145" textAnchor="middle" className="fill-primary-700 dark:fill-[oklch(85%_0.005_50)]" fontSize="12" fontWeight="600">
            {flight.route.from}
          </text>
          {/* Arrival label */}
          <text x="360" y="125" textAnchor="middle" className="fill-primary-700 dark:fill-[oklch(85%_0.005_50)]" fontSize="12" fontWeight="600">
            {flight.route.to}
          </text>
        </svg>
        ...
        >
          <div className="bg-primary-500 dark:bg-[oklch(65%_0.194_262)] rounded-full p-1.5 shadow-md">
      ...
      {/* Progress bar */}
      <div className="px-4 py-3 bg-surface dark:bg-[oklch(18%_0.003_50)]">
        ...
        <div className="h-1.5 bg-surface-200 dark:bg-[oklch(25%_0.005_50)] rounded-full overflow-hidden">
          <div
            className="h-full bg-primary-500 dark:bg-[oklch(65%_0.194_262)] rounded-full transition-all duration-[--duration-long]"
        ...
        <div className="flex items-center justify-between mt-1.5">
          ...
          <span className="text-xs font-medium text-primary-900 dark:text-[oklch(95%_0.002_50)]">
            {hoursRemaining}h {minutesRemaining}m remaining
          </span>
        </div>

        {/* Destination weather */}
        <div className="flex items-center gap-3 mt-3 pt-3 border-t border-surface-300 dark:border-[oklch(32%_0.008_50)]">
          <div className="flex items-center gap-1.5">
            <CloudSun className="w-4 h-4 text-info-500 dark:text-info-400" aria-hidden="true" />
            <span className="text-xs text-primary-700 dark:text-[oklch(85%_0.005_50)]">
